...
public class DeleteDataAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			...
			if(usertype.equals("user")) {
				...
				try {
					if(!ao.validateUserOperation(master, tableName, ao.getUserTypeForTable(master, username, tableName), true)) {
						...
						out.println("window.location=\"/viewTableDetail.do?tableName=" + tableName + "&type=browseTable\";");
						out.println("</script>");
		...
		try {
			dao.deleteData(master,tableName,rowKey);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		
		return new ActionForward("/viewTableDetail.do?tableName=" + tableName + "&type=browseTable");
	}
}