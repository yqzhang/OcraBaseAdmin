...
<html>
  <head>
	...
	<%
		...
		int resultSize = ((dataOperation)request.getSession().getAttribute("QUERYDATA")).getResultSize();
	%>
  ...
  <body>
    <table border="0" cellpadding="5" cellspacing="2">
    	...
    	<tr>
    		<td>
    			<a href="/queryDataResult.do?page=0">
    				First
    			</a>
    			<%
    				if(presentPage <= 0) {
    			...
    			%>
    			<a href="/queryDataResult.do?page=<%=presentPage - 1 %>">
    				Previous
    			</a>
    			<%
    				}
    			...
    			%>
    			<a href="/queryDataResult.do?page=<%=(resultSize - 1) / 20 %>">
    				Last
    			</a>
    		</td>
    	</tr>
